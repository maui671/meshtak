...
class RadioSettings {
        ...
        panel.innerHTML = `
            <div class="r-stage">
                <div class="r-shell">
                    ...
                    <div id="r-card-mqtt"></div>
                    <div id="r-card-tak"></div>
    ...
    _buildCards() {
        ...
        const mqtt = new RadioMqttCard(api);
        mqtt.mount(document.getElementById('r-card-mqtt'));
        this._cards.push(mqtt);

        const tak = new RadioTakCard(api);
        tak.mount(document.getElementById('r-card-tak'));
        this._cards.push(tak);
    ...
    _buildApi() {
        ...
        return {
            ...
            restartService:(reason) => self._restartService(true, reason),
    ...
    async _restartService(skipConfirm = false, restartMsg = '') {
        if (!skipConfirm) {
            const ok = confirm(
